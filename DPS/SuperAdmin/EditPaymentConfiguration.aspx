<%@ Page Title="" Language="C#" MasterPageFile="~/SuperAdmin/SuperAdminMaster.Master" AutoEventWireup="true" CodeBehind="EditPaymentConfiguration.aspx.cs" Inherits="DPS.SuperAdmin.EditPaymentConfiguration" Async="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="form-wrapper">
        <div class="row">
            <div class="col-md-12">
                <h4><b>Edit School Payment Configuration</b></h4>
                <br />
            </div>
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                ...
                <div class="form-group">
                    <asp:TextBox ID="txtMerchantPassword" CssClass="form-control"  AutoCompleteType="Disabled" ValidationGroup="PaymentConfig" runat="server"></asp:TextBox>
