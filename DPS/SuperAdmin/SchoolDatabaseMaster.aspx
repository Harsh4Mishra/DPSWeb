<%@ Page Title="" Language="C#" MasterPageFile="~/SuperAdmin/SuperAdminMaster.Master" AutoEventWireup="true" CodeBehind="SchoolDatabaseMaster.aspx.cs" Inherits="DPS.SuperAdmin.SchoolDatabaseMaster" %>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="d-flex justify-content-start align-items-center">
                                <div class="col-sm-flex">
                                    <asp:LinkButton ID="LinkButtonAdd" runat="server" class="btn btn-info" Style="border-radius: 5px" OnClick="LinkButtonAdd_Click"><i class="fa fa-plus" style="font-size:medium"></i> &nbsp;School Database</asp:LinkButton>
                    ...
                    <div class="table-responsive">
                        <asp:GridView ID="GridView1" runat="server" AllowSorting="True" Width="100%" BackColor="White" BorderColor="#dbdade"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Database Name" SortExpression="DATABASE_NAME">
                                    <ItemTemplate>
                                        <asp:Label ID="lblDatabaseName" runat="server" Text='<%# Eval("DATABASE_NAME") %>' />
                                    </ItemTemplate>
                                    <ItemStyle HorizontalAlign="Center" Width="20%" />
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="Academic Year" SortExpression="ACADEMIC_YEAR">
                                    <ItemTemplate>
                                        <asp:Label ID="lblAcademicYear" runat="server" Text='<%# Eval("ACADEMIC_YEAR") %>' />
                                    </ItemTemplate>
                                    <ItemStyle HorizontalAlign="Center" Width="20%" />
                                </asp:TemplateField>
