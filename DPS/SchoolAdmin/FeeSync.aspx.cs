...
namespace DPS.SchoolAdmin
{
    public partial class FeeSync : System.Web.UI.Page
    {
        ...
        private void TransferData(string mdfFilePath, string databaseName)
        {
            ...
            string sqlServerConnectionString = @"Data Source=150.242.203.229,9144;Initial Catalog=" + databaseName + ";User Id=dpsuser;Password=dps@123;Integrated Security=False;MultipleActiveResultSets=True;Connect Timeout=5000;";
