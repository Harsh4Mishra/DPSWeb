        ...
        public string ConnectionString()
        {
            ...
            if (HttpContext.Current != null && HttpContext.Current.Session != null)
            {
                ...
                if (!string.IsNullOrEmpty(databaseName))
                {
                    ...
                    connection = "Data Source=150.242.203.229,9144;Initial Catalog=" + databaseName + ";User Id=dpsuser;Password=dps@123;Integrated Security=False;MultipleActiveResultSets=True;Connect Timeout=60000;"; // Replace with your default
                }
            }
