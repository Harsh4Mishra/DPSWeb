<%@ Page Title="" Language="C#" MasterPageFile="~/SchoolAdmin/SchoolMaster.Master" AutoEventWireup="true" CodeBehind="FeeSync.aspx.cs" Inherits="DPS.SchoolAdmin.FeeSync" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="form-wrapper">
        <div class="row">
            <div class="col-md-12">
                <h4><b>Syncronized Database</b></h4>
                <br />
            </div>
            <!-- Logo Field -->
            <div class="col-md-4">
