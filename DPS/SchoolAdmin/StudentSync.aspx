<%@ Page Title="" Language="C#" MasterPageFile="~/SchoolAdmin/SchoolMaster.Master" AutoEventWireup="true" CodeBehind="StudentSync.aspx.cs" Inherits="DPS.SchoolAdmin.StudentSync" %>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="row">
                    ...
                    <div class="col-md-flex">
                        <asp:Button ID="btnCancel" Style="border-radius: 5px" class="btn btn-block btn-cancel font-weight-medium auth-form-btn" runat="server" Text="Download" OnClick="btnCancel_Click" />
                    </div>
                </div>
            </div>
        </div>
